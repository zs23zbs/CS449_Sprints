...
from new_game_logic import GameLogic
...
class SOSGame(): 
    def __init__(self):
        ...
        self.current_letter_choice = tk.StringVar(value="S") # new for changing turn mechanic
    ...
    def handle_click(self, row, col):
        ...
        letter = self.current_letter_choice.get()
    ...
    def update_turn_display(self):
        ...
        self.red_label.config(text=f"RED PLAYER (R): {self.game.player_red}")
        self.blue_label.config(text=f"BLUE PLAYER (B): {self.game.player_blue}")
